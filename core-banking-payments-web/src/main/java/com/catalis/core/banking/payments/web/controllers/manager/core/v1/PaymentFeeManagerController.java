...
import com.catalis.core.banking.payments.core.services.manager.core.v1.PaymentFeeManagerServiceImpl;
...
@Tag(name = "Payment Fees (Manager)",
        description = "APIs for managing payment fees in a manager context")
@RestController
@RequestMapping("/api/v1/manager/payment-orders/{paymentOrderId}/fees")
