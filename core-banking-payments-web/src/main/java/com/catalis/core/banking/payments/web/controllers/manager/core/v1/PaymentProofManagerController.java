...
import com.catalis.core.banking.payments.core.services.manager.core.v1.PaymentProofManagerServiceImpl;
...
@Tag(name = "Payment Proofs (Manager)",
        description = "APIs for managing payment proofs in a manager context")
@RestController
@RequestMapping("/api/v1/manager/payment-orders/{paymentOrderId}/proof")
