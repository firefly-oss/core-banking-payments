...
import com.catalis.core.banking.payments.core.services.manager.core.v1.PaymentScheduleManagerServiceImpl;
...
@Tag(name = "Payment Schedules (Manager)",
        description = "APIs for managing payment schedules in a manager context")
@RestController
@RequestMapping("/api/v1/manager/payment-orders/{paymentOrderId}/schedules")
