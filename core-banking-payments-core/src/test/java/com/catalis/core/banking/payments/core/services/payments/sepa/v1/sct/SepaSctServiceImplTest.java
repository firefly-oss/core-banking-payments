...
public class SepaSctServiceImplTest {

    @InjectMocks
    private SepaSctServiceImpl service;

    private final Long accountId = 1234L;
    private SepaSctPaymentSimulationRequestDTO simulationDTO;
    private SepaSctPaymentExecutionRequestDTO executionDTO;
    ...
    void setUp() {
        ...
        simulationDTO = SepaSctPaymentSimulationRequestDTO.builder()
        ...
        // Setup execution DTO
        executionDTO = SepaSctPaymentExecutionRequestDTO.builder()
        ...
        responseDTO = PaymentOperationResponseDTO.builder()
                .methodType(PaymentMethodTypeEnum.SEPA_SCT)
                .operationReference("OP-REF-123")
                .status("SUCCESS")
